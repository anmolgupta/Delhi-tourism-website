...
<br />
	<div id="wrapper">
		...
		<div id="left" style="float:left;height:581px; width:191px;">
            ...
            <table class="style1">
                ...
                <tr>
                    <td class="style2">
                        Password</td>
                    <td>
                        <asp:TextBox ID="TxtPassword" runat="server" TextMode="Password" Width="119px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style2">
                ...
                <tr>
                    <td class="style2" colspan="2">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:LinkButton ID="lnkbtn1" 
                            runat="server" ForeColor="Red" onclick="lnkbtn1_Click">forgot password ??</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td class="style2" colspan="2">
                        &nbsp;&nbsp;not&nbsp; a member ?
                        <asp:LinkButton ID="lnkbtn2" runat="server" ForeColor="Red" 
                            onclick="lnkbtn2_Click">sign up !!</asp:LinkButton>
                        <br />
                    </td>
                </tr>
            </table>
...
<p style="text-align:justify"> <font  size="2" color="black"> 
...
<a href="login.aspx">Home</a>   |   <a href="gotosinup.aspx">Delhi map</a>   |   <a href="gotosinup.aspx">Services</a>   |   <a href="gotosinup.aspx">Tourist attractions</a>   |   <a href="gotosinup.aspx">Contact us</a>   |   <a href="gotosinup.aspx">Feedback</a>																																																																													
        ...
        <%--change starts here--%>
		  <div class="right_block" style="float:right ; background-color:ActiveBorder">
...
<br />
			...
			<div class="right_block" style="float:right">
				...
				<p class="title3"><font size="5" color="red"> Currency Converterer</font></p>
